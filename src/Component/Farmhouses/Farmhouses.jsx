...
function Farmhouses() {
  return (
    <div id='houses'>
      <Card image1={house} image2={house1} image3={house2} title={"3BHK Villa in Tamilnadu"} price={"40,000"}/>
      <Card image1={villa2} image2={villa} image3={villa1} title={"2BHK Modern Villa in Tamilnadu"} price={"50,000"}/>
      <Card image1={village} image2={village1} image3={village2} title={"2BHK house in Tirupati"} price={"30,000"}/>
